...
use LaravelFrontend\App\Controllers\CheckoutAuth;
use LaravelFrontend\Cms\CmsCart;

/**
 * Checkoutauth route controller
 *
 * You can put some custom logic and behaviour for the route checkoutauth.
 * This file is optional, it can even be deleted if desired.
 */
class RouteCheckoutauth extends CheckoutAuth
{
    /**
