...
Route::prefix('_/hooks')
  ...
  ->group(function () {
    ...
    Route::get('cache/clear-system', [HooksController::class, 'clearSystem']);
    ...
    Route::get('cache/clear-custom', [HooksController::class, 'clearCustom']);

    Route::get('cache/clear-models', [HooksController::class, 'clearModels']);
    ...
    Route::get('cache/clear-routes', [HooksController::class, 'clearRoutes']);
