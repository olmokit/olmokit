...
class CmsCart
{
  ...
  {
    if (!$cartitemid) {
      throw new Error("CmsCart::delete called without argument 'cartitemid'");
    }

    $data = ['cartitemid' => $cartitemid];

    $response = CmsApi::deleteWithAuth('[guest]{locale}/shoppingcart', $data);
  ...
  {
    $response = CmsApi::deleteWithAuth('[guest]{locale}/shoppingcart/discount');
