...
Route::prefix('_/cms/')
  ...
  ->group(function () {
    ...
    Route::post('/cart/quantity', [CmsCartController::class, 'setQuantity']);
    Route::post('/cart/addresses', [CmsCartController::class, 'setAddresses']);
    Route::post('/cart/discount', [CmsCartController::class, 'applyDiscount']);
