 ...
 * Detect device
 *
 * For now almost just as [`ismobilejs`](https://github.com/kaimallea/isMobile/)
 *
 * Differences:
 * - `phone` also includes `apple.ipod`
 *
 * @see https://github.com/kaimallea/isMobile/blob/master/src/isMobile.ts
 */
export function device(param?: IsMobileParameter): isMobileResult {
  let nav: Navigator = {
    userAgent: "",
    platform: "",
    maxTouchPoints: 0,
