...
export const createTaskr = <TCtx>(custom: TaskrSetupOptions<TCtx>) => {
  ...
  // const createLogger = <ErrorContext = Error>(
  //   ...args: [] | [string | Identity | undefined] | [string, Identity]
  // ): TaskrLogger => {
  //   let initialLogLevel = 0; // LogLevel.info;

  //   let globalAppender: Appender<any>;

  //   const appender = <ErrorContext = Error>(
  ...
  //     globalAppender && globalAppender(message);
  //   };

  //   const inputId = globalInputId++;
  //   const getOptions = (
  //     options: [] | [string | Identity | undefined] | [string, Identity]
  //   ): { tag?: string; parentId?: number } => {
  //     let parentId, tag;
  //     if (options.length === 1) {
  ...
  //   ) => {
  //     myAppender &&
  //       // @ts-expect-error FIXME: logger intricacies
  //       myAppender({
  //         action,
  //         inputId,
  //         message,
  ...
  //       // custom methods
  //       info(message: string, loglevel?: LogLevel, context?: ErrorContext) {
  //         append(message, Action.finish, LogLevel.info, context);
  //       },
  //       success(message: string, loglevel?: LogLevel, context?: ErrorContext) {
  //         append(message, Action.finish, LogLevel.success, context);
  //       },
  //       warn(message: string, loglevel?: LogLevel, context?: ErrorContext) {
  //         append(message, Action.finish, LogLevel.warn, context);
  //       },
  //       error(message: string, loglevel?: LogLevel, context?: ErrorContext) {
  //         append(message, Action.finish, LogLevel.error, context);
  //       },
  //     }
  //   );
  ...
  //   return loggerInstance as TaskrLogger;// as typeof loggerInstance & Identity;
  // };
