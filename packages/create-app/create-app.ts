...
function createApp(
  ...
  console.log(`Creating a new Olmo app in ${chalk.magenta(root)}.`);
  console.log();
    ...
    Promise.all([
      ...
      .then(async ({ packageInfo, templateInfo }) => {
        ...
        await executeNodeScript(
          ...
          `await import("${packageName}/cli-laravel/bootstrap").apply(null, JSON.parse(process.argv[1]));`
          //     `
